#ifndef DetectorAPConstruction_h
#define DetectorAPConstruction_h
...
class DetectorAPConstruction : public G4VUserDetectorConstruction, public MsgService
{
  public:
    DetectorAPConstruction(std::string);
    virtual ~DetectorAPConstruction();
